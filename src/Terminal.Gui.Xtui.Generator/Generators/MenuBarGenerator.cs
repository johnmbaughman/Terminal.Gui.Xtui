...
/// <summary>
/// Terminal.Gui.Xtui.Generator.Helpers.Generator for MenuBar controls. MenuBars are horizontal menus that can contain MenuBarItems.
/// </summary>
internal sealed class MenuBarGenerator : BaseGenerator
{
    /// <inheritdoc />
