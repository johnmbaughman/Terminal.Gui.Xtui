    ...
    public static ExpressionSyntax ParseValueWithType (string value, string propertyName)
    {
        ...
        switch (expectedType)
        {
            ...
            case "MouseState":
                ...
                string enumExpression = Terminal.Gui.Xtui.Generator.Mappers.EnumMapper.GetEnumValue (expectedType, value);
            ...
            case "Command":
                ...
                string cmdExpression = Terminal.Gui.Xtui.Generator.Mappers.EnumMapper.GetEnumValue ("Command", value);
