...
public class CodeGenerationException : XamlException
{
    ...
    /// </summary>
    public new string? LocalizedMessage { get; set; }
    ...
    {
        string message = $"Cannot generate code for type '{typeName}'. The type is not supported or cannot be found.";
    ...
    {
        string message = $"Generated code for class '{className}' failed to compile: {compilationError}";
        return new CodeGenerationException (message)
        {
            ClassName = className,
    ...
    {
        string message = $"Code generation template '{templateName}' failed for class '{className}': {templateError}";
        return new CodeGenerationException (message)
        {
            ClassName = className,
